...
export function cssRangeToVSCodeRange(line: TextLine, range: CSSRange) {
  return new VSCodeRange(
    new Position(line.lineNumber, range.start.character),
    new Position(line.lineNumber, range.end.character)
  );
}
